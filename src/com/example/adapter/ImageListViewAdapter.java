...
public class ImageListViewAdapter extends BaseAdapter {
	...
	public ImageListViewAdapter(Context context, int layout,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.textView.setText(" " + datalist.get(position).get(from[1]));
	...
	private void postChouChang(final int index) {
		new Thread(new Runnable() {
			String url = "http://1.zmj520.sinaapp.com/servlet/DealWithThemeCollectNums";
