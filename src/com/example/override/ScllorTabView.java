...
import com.example.classfy.R.styleable;
...
public class ScllorTabView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		final float right = (mCurrentNum + mOffset) * mTabWidth + mTabWidth - width / 2;
		final float top = getPaddingTop();
		final float bottom = getHeight() - getPaddingBottom();

		// if (gradient == null) {
		// LinearGradient gradient = new LinearGradient(left, getHeight(),
		// right,
		// getHeight(), mBeginColor, mEndColor, S);
